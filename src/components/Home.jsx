...
export default function Home() {
  ...
  return (
    <section id='home' className='flex-center container min-h-screen gap-8 py-40 max-lg:flex-col lg:justify-between'>
      <div className='max-w-lg max-lg:text-center'>
        ...
        <h1 className='mb-6'>
          Hi, I'm <span className='text-accent'>Ziad</span>. Building digital experiences that matter.
        </h1>
        <p className='mb-8'>
      ...
      <div className='relative aspect-square w-full max-w-lg'>
        <div className='absolute top-0 right-0 bottom-12 left-12 aspect-square overflow-hidden rounded-3xl'>
          <img src='src/assets/laptop.jpg' alt='' className='size-full object-cover' />
