...
async function getScreenshot(url, fileName) {
  const microlinkUrl = `https://api.microlink.io?url=${encodeURIComponent(url)}&screenshot=true&meta=false&type=jpeg&viewport.width=1280&viewport.height=720&waitUntil=networkidle2`
